...
return [
    ...
    | múltiples versiones como las reglas de tamaño. Puedes ajustar cada mensaje.
    |
    */
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas de idioma se usan para reemplazar nuestro marcador
    | de posición de atributo con algo más amigable como "Dirección de Correo"
    | en lugar de "email". Esto simplemente nos ayuda a hacer el mensaje más expresivo.
    |
    */
